...
public class SPCBatteryChangeService {
	private String batteryBrand;
	private String tipoBateria;
	private String referencia;
	public SPCBatteryChangeService(String batteryBrand, String tipoBateria,
			String referencia) {
		super();
	...
	public String toString() {
		return "SPCBatteryChangeService [batteryBrand=" + batteryBrand
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SPCBatteryChangeService other = (SPCBatteryChangeService) obj;
