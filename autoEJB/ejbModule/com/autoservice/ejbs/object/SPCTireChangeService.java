...
public class SPCTireChangeService {
...
/*	public int getAltura() {
	...
	*/
	...
	public String toString() {
		return "SPCTireChangeService [marcaPredilecta=" + marcaPredilecta
				+ ", quantity=" + quantity + ", referencia=" + referencia + "]";
	}
	public SPCTireChangeService(String referencia, String marcaPredilecta,
			int quantity) {
		super();
		this.referencia = referencia;
		this.marcaPredilecta = marcaPredilecta;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SPCTireChangeService other = (SPCTireChangeService) obj;
