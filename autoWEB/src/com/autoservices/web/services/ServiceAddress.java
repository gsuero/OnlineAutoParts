...
public class ServiceAddress {
	...
	public ServiceAddress(ShoppingCartAddress address) {
		this.ciudad = address.getCiudad();
		this.sector = address.getSector();
		this.calle = address.getCalle();
		this.numero = address.getNumero();
		this.edificio = address.getEdificio();
		this.apartamento = address.getApartamento();
		this.celular = address.getCelular();
		this.telefono = address.getTelefono();
		this.referencias = address.getReferencias();
	}
	public ServiceAddress(String ciudad, String sector, String calle,
	...
	public String toString() {
		return "ServiceAddress [apartamento=" + apartamento + ", calle="
